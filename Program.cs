...
Console.Write("Введите положительное число элементов массива: ");
...
if (size > 0)
{
    ...
    Console.Write("Введенный пользователем массив: ");
    PrintArray(stringArray);

    string[] newStringArray = SelectThreeSymbolString(stringArray);

    Console.Write("Отсортированный массив согласно условия задачи: ");
